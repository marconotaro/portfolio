...
- identify upregualted (positive) and dowregualted (negative) markers of the Basal cluster (cluster 5) compared to all the others; 
...
As the next step, the cluster assignment can be used to train supervised machine learning models to predict the ER status for those patients where the ER status is unknown.
